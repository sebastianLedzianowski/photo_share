...
test_pictures = {
    "picture_1": picture(1, 1, 3, "Kamileusz", "family", "Kamileusz' family", "family of Kamileusz", datetime(2023-02-02)),
    "picture_2": picture(2, 1, 5, "Kamil", "rodzina", "Rodzina Kamila", "Rodzinka Kamilka", datetime(2022-02-02))
}
